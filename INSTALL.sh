...
$mambaforgebin/mamba install -y cython ncurses sed
...
$mambaforgebin/conda install --no-deps -n qiime2 bioconda::unifrac=1.3 bioconda::unifrac-binaries=1.4 dbrown::szip
echo "
------------------------------------------------------------------------------
